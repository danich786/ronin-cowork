...
A **`project_root`** is *where* the work happens. It is used by launch forms, memory
frontmatter, and macros. One lookup fixes: where to work (`dir`), what a cold agent reads first (`read`),
