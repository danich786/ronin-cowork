...
| `garden-canvas-model.js` / `garden-canvas.js` | versioned four-region content normalization and the stable Setup Workspace 1 canvas, including its media overlay and exactly-once transition gate |
