export const SETUP_SCENES = Object.freeze([
  ...
  { id: 'register', label: 'Register', selector: true, visibleTypes: ['setup.providers', 'setup.register'], seats: { workspace1: '', workspace2: 'setup.register' } },
  { id: 'tailored', label: 'Tailored setup', selector: true, visibleTypes: ['setup.roots', 'setup.installations', 'setup.bounty', 'setup.launch-own'], seats: { workspace1: '', workspace2: 'setup.roots' } },
  ...
  { id: 'installations', label: 'Installations', selector: true, visibleTypes: ['setup.roots', 'setup.installations'], seats: { workspace1: '', workspace2: 'setup.installations' } },
  { id: 'launch', label: 'Choose a start', selector: true, visibleTypes: ['setup.launch-own'], seats: { workspace1: '', workspace2: 'setup.launch-own' } },
  { id: 'ready', label: 'Ready', selector: true, visibleTypes: ['setup.providers', 'setup.register', 'setup.roots', 'setup.installations', 'setup.bounty', 'setup.launch-own'], seats: { workspace1: '', workspace2: 'setup.launch-own' } },
...
function projectedScene(number, runtime) {
  ...
  return Object.freeze({
    ...
    seats: Object.freeze(software
      ? { workspace1: '', workspace2: 'setup.roots' }
