...
import { DISMISSED_WORKSPACE, WORKSPACE_DESTINATIONS, navigateWorkspace, rememberedWorkspaceSeat, teamWorkspaceState, workspaceMaySeedDefault, workspaceTarget } from './workspace-contract.js';
...
export const WorkspaceKit = Object.freeze({
  ...
  contract: Object.freeze({ DISMISSED_WORKSPACE, destinations: WORKSPACE_DESTINATIONS, navigateWorkspace, rememberedWorkspaceSeat, teamWorkspaceState, workspaceMaySeedDefault, workspaceTarget }),
});
