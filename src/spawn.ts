...
const CORE_CONTRIBUTION: ResolvedContribution = {
  ...
  tools: ['tejun', 'tejun-step', 'tejun-send', 'session_end', 'session_archive', 'session_restore', 'tejun-team', 'session_fork', 'session_check', 'session_set', 'tejun-team-set', 'tejun-wipeboard', 'tejun-teampage', 'tejun-peek', 'read_tegami', 'write_tegami', 'tejun-jikan', 'ronin-url'],
