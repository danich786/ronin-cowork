...
export const AGENTS = [
  ...
  { id: 'grok', controls: { stop: ['C-c'], clear: [] }, cmd: 'grok', label: 'Grok CLI', operations: { install: 'npm install -g @xai-official/grok', update: { shell: 'npm install -g @xai-official/grok@latest', argv: [] }, selfUpdates: true, version: ['--version'], session: { newIdFlag: '', resume: [], discovery: 'unsupported' } } as AgentOperations, parked: '', credentials: ['.grok/auth.json'], initial: 'positional' as InitialPrompt, screen: { busy: [], asking: [], ready: [] } },
  {
    id: 'hermes',
    controls: { stop: ['C-c'], clear: [] },
    cmd: 'hermes',
