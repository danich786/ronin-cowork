...
Commit coherent checkpoints on the repository's working line. There is no private desk,
...
Use the repository's declared working and stable branches. Git push remains release work
only when the task explicitly authorizes it.
