...
| instruction cascade | **installation**<!--g:glossary.installation--> · **feature**<!--g:glossary.feature--> · **behaviour**<!--g:glossary.behaviour--> | A Campaign installation is a system switch: it joins every Cowork Agent or makes features selectable. A feature is an extra facility or taught practice. A behaviour is one short page saying how ordinary work is done; **Mandates** is on by default. System settings holds **Installations**<!--g:glossary.installations--> and **Defaults**<!--g:glossary.defaults-->. **Services**<!--g:glossary.services--> is a rented capability, never a module, plug-in, extension or applet. |
