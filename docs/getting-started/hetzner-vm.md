...
remote agent then follows [`docs/getting-started/install.md`](install.md) to install Ronin. If you already
...
> Open https://github.com/ronincowork/ronin-cowork/blob/master/docs/getting-started/install.md and follow
