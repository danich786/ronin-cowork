...
Open **Ronin Setup → Workspace folders** and follow [Workspace folders](../architecture/project-roots.md).
...
Show the owner **＋ New**, the roster, and [how to find work in the Workbench](../using-ronin/workbench.md).
