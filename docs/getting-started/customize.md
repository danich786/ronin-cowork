...
Related reference: [Agent controls and integration](../using-ronin/terminal-controls.md).
...
- `docs/getting-started/customize.md` — this persistent implementation and resume contract.
...
convention is now settled by `docs/architecture/workspace-kit.md` and enforced by
