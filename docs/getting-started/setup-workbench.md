...
sign-in can take you straight to Ready; otherwise Authenticate remains the next step.
This works in both Ronin Setup and Ronin Settings, using the same embedded terminal as
GitHub setup in Workspace folders. Closing the window ends its temporary session.
