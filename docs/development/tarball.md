...
>
> `docs/development/release.md` remains the mechanics of the cowork release — the tag, the CI build,
...
1. **Refresh the provider catalog.** `ronin_catalogs/MODEL_PROVIDERS.md` is a snapshot of
   ...
   thing that keeps it true (`docs/architecture/model-providers.md`, *Keeping it fresh*).
