...
Run `npm run verify` for the TypeScript and behavior-test verdict. Playwright commands
are explicit UI diagnostics. Follow the installed-user checks when changing an installed
