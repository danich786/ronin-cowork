...
| *Stay or go* — the desk an Agent lives in is parked or ends with the Agent; nobody asks it to leave | `ronin_catalogs/behaviours/worktree-root.md`, "Finish the assignment" |
