...
2. **The maps** — `docs/README.md`, the question-first index, and `docs/architecture/RONIN_UTILITY.md`,
...
Put the file on the shelf (`docs/architecture/session-boot.md` says where each level reaches) and run
