...
the separate public contract in `docs/architecture/model-providers.md`. That document may name an
environment variable; this page governs its value and where that value may live.
