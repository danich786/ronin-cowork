...
Model/provider wiring is documented in `docs/architecture/model-providers.md`; the credentials that
make those providers usable follow `secrets.md`. This page records neither.
