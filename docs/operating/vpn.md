...
> at the end; the whole of this guidance is about moving that address and then proving it moved.
...
already; the situation that fetched this page is nearly always someone who is not sure what
...
say they understand.** This is the page's main instruction. Everything below is easy; the
...
- **It contains a list of their machines, and that list is the whole idea.** Get them to open
  ...
  phone sitting in one list, everything else in this page explains itself, and they stop
  needing you.
...
as the only thing between a stranger and the box. It is not part of this page.
