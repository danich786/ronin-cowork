...
1. Work at your repo desk (`ronin_catalogs/behaviours/conditional/worktree-root.md`), never on `master`.
2. Read this file and `docs/architecture/workspace-kit.md` completely.
